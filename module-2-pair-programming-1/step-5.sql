/*
 STEP ONE: Add a new park with the following data:
  ...
  ------------------------------
*/
insert into park(name, location, establish_date, area, visitors, description) values('Ohiopyle State Park', 'Pennsylvania', '1965-01-01', '19052', '100000', 'Ohiopyle State Park is a Pennsylvania state park on 19,052 acres in Dunbar, Henry Clay and Stewart Townships, Fayette County, Pennsylvania in the United States. The focal point of the park is the more than 14 miles of the Youghiogheny River Gorge that passes through the park.');
...
*/
insert into reservation(site_id, name, from_date, to_date) values('623', 'Wayne Family', (select current_date + INTERVAL'10 days'), (select current_date + INTERVAL'20 days')), ('624', 'Parker Family', (select current_date + INTERVAL'11 days'), (select current_date + INTERVAL'20 days')), ('625', 'Kent Family', (select current_date + INTERVAL'12 days'), (select current_date + INTERVAL'20 days')); 
 ...
 */
update reservation set from_date = (select current_date) , to_date = (select current_date + INTERVAL '7 days') where name = 'Wayne Family';
